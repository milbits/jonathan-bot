...
module.exports = {
	...
	async execute(client, interaction) {
		...
		var list = [
			...
			"kys",
			"sure",
			"hold on i have a gif for this, gimme a few years",
			"nah",
			"what 💀",
			...
			`this question is so TUFF 🗿🗿🗿 THOSE WHO 67 ON ${question}: SKIBIDI 41 MUSTARD``those who ${question}: :skull: :skull: :skull:`,
			"meow meow meow meow! :3c meow meow!",
			"woof woof woof woof! :D woof woof!",
			...
			"idk but sometimes i breathe, is that normal? chat? is this normal? ",
			"idc lets play minecraft",
			"*chokes you*",
